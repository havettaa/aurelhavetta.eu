...
var BoolCellFormatter = function(row, cell, value, columnDef, dataContext) {
    return value ? "<img src='../css/slick.grid/images/tick.png'>" : "";
};

var TaskNameFormatter = function(row, cell, value, columnDef, dataContext) {
    // todo:  html encode
    var spacer = "<span style='display:inline-block;height:1px;width:" + (2 + 15 * dataContext["indent"]) + "px'></span>";
    return spacer + " <img src='../css/slick.grid/images/expand.gif'>&nbsp;" + value;
};
...
var ResourcesFormatter = function(row, cell, value, columnDef, dataContext) {
	...
	if (columnDef.width < 50)
		return (resources.length > 1 ? "<center><img src='../css/slick.grid/images/user_identity_plus.gif' " : "<center><img src='../css/slick.grid/images/user_identity.gif' ") +
...
var StarFormatter = function(row, cell, value, columnDef, dataContext) {
    return (value) ? "<img src='../css/slick.grid/images/bullet_star.png' align='absmiddle'>" : "";
};
...
var DateCellEditor = function($container, columnDef, value, dataContext) {
    ...
    this.init = function() {
        ...
        $input.datepicker({
            ...
            buttonImage: "../css/slick.grid/images/calendar.gif"
        });
...
var StarCellEditor = function($container, columnDef, value, dataContext) {
    ...
    this.init = function() {
        $input = $("<IMG src='../css/slick.grid/images/bullet_star.png' align=absmiddle tabIndex=0 title='Click or press Space to toggle' />");
