...
jQuery.sap.declare('com.tutorial.service.measureobject.MOFeaturesInnovationService');

com.tutorial.service.measureobject.MOFeaturesInnovationService = {
	...
	CONSTANTS : {
		CATALOG_COLLECTION_QUERY : 'FEATURESINNOVATION',
	...
	updateModel : function(modelData) {
		com.tutorial.service.generic.ODataToJsonService.createLog("FEATURESINNOVATION", "update", modelData['updatedData'], modelData['moKey']);
		var successFunc = modelData['successFunc'];
		var errorFunc = modelData['errorFunc'];
	...
	removeModel : function(modelData) {
		com.tutorial.service.generic.ODataToJsonService.createLog("FEATURESINNOVATION", "delete", modelData['moKey'], modelData['moKey']);
		var successFunc = modelData['successFunc'];
		var errorFunc = modelData['errorFunc'];
		var endpointParam = this.CONSTANTS.CATALOG_COLLECTION_QUERY + "('" + modelData['moKey'] + "')";
		var curriedSuccessFunc = com.tutorial.util.Utils.curry(successFunc);
	...
	createModel: function(noteContext) {
		com.tutorial.service.generic.ODataToJsonService.createLog("FEATURESINNOVATION", "insert", noteContext['moData'], noteContext['moData']["KEY"]);
