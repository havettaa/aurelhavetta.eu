...
jQuery.sap.declare('com.tutorial.service.measureobject.MeasurementObjectSolutionService');

com.tutorial.service.measureobject.MeasurementObjectSolutionService = {
	...
	CONSTANTS : {
		CATALOG_COLLECTION_QUERY : 'SOLUTIONMO',
	...
	updateModel : function(modelData) {
		com.tutorial.service.generic.ODataToJsonService.createLog("SOLUTIONMO", "update", modelData['updatedData'], modelData['moKey']);
		var successFunc = modelData['successFunc'];
		var errorFunc = modelData['errorFunc'];
	...
	removeModel : function(modelData) {
		com.tutorial.service.generic.ODataToJsonService.createLog("SOLUTIONMO", "delete", modelData['moKey'], modelData['moKey']);
		var successFunc = modelData['successFunc'];
		var errorFunc = modelData['errorFunc'];
		var endpointParam = this.CONSTANTS.CATALOG_COLLECTION_QUERY + "('" + modelData['moKey'] + "')";
		var curriedSuccessFunc = com.tutorial.util.Utils.curry(successFunc);
	...
	createModel: function(noteContext) {
		com.tutorial.service.generic.ODataToJsonService.createLog("SOLUTIONMO", "insert", noteContext['moData'], noteContext['moData']["KEY"]);
