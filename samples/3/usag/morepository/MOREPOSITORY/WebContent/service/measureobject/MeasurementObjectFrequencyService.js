...
jQuery.sap.declare('com.tutorial.service.measureobject.MeasurementObjectFrequencyService');

com.tutorial.service.measureobject.MeasurementObjectFrequencyService = {
	...
	CONSTANTS : {
		CATALOG_COLLECTION_QUERY : 'MEASUREMENT_FREQUENCY',
		ASYNC : false
	},
	...
	updateModel : function(modelData) {
		com.tutorial.service.generic.ODataToJsonService.createLog("MEASUREMENT_FREQUENCY", "update", modelData['updatedData'], modelData['moKey']);
		var successFunc = modelData['successFunc'];
		var errorFunc = modelData['errorFunc'];
	...
	removeModel : function(modelData) {
		com.tutorial.service.generic.ODataToJsonService.createLog("MEASUREMENT_FREQUENCY", "delete", modelData['moKey'], modelData['moKey']);
		var successFunc = modelData['successFunc'];
		var errorFunc = modelData['errorFunc'];
		var endpointParam = this.CONSTANTS.CATALOG_COLLECTION_QUERY + "('" + modelData['moKey'] + "')";
		var curriedSuccessFunc = com.tutorial.util.Utils.curry(successFunc);
	...
	createModel: function(noteContext) {
		com.tutorial.service.generic.ODataToJsonService.createLog("MEASUREMENT_FREQUENCY", "insert", noteContext['moData'], noteContext['moData']["KEY"]);
