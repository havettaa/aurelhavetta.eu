...
jQuery.sap.declare('com.tutorial.service.measureobject.MeasurementObjectAssignmentsPackageService');

com.tutorial.service.measureobject.MeasurementObjectAssignmentsPackageService = {
	...
	CONSTANTS : {
		CATALOG_COLLECTION_QUERY : 'PACKTABLE?$filter=PARENTID eq \'{0}\'',
		ASYNC : true
	},
	...
	updateModel : function(modelData) {
		...
		com.tutorial.service.generic.ODataToJsonService.createLog("PACKAGE", "update", modelData.updatedData, modelData.moKey);
		var successFunc = modelData.successFunc;
		var errorFunc = modelData.errorFunc;
