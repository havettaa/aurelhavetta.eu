...
jQuery.sap.declare('com.tutorial.service.measureobject.MeasurementObjectPKPrimaryInfoService');

com.tutorial.service.measureobject.MeasurementObjectPKPrimaryInfoService = {
	...
	CONSTANTS :{
		CATALOG_COLLECTION_QUERY : 'PACK?$filter=KEY eq \'{0}\'', 
		ASYNC : true
	},
