...
jQuery.sap.declare('com.tutorial.service.measureobject.MeasurementObjectTypesService');

com.tutorial.service.measureobject.MeasurementObjectTypesService = {
	...
	CONSTANTS : {
		CATALOG_COLLECTION_QUERY : 'OBJTYPES',
		ASYNC : false
	},
	...
	updateModel : function(modelData) {
		com.tutorial.service.generic.ODataToJsonService.createLog("OBJECT_TYPES", "update", modelData['updatedData'], modelData['moKey']);
		var successFunc = modelData['successFunc'];
		var errorFunc = modelData['errorFunc'];
	...
	removeModel : function(modelData) {
		com.tutorial.service.generic.ODataToJsonService.createLog("OBJECT_TYPES", "delete", modelData['moKey'], modelData['moKey']);
		var successFunc = modelData['successFunc'];
		var errorFunc = modelData['errorFunc'];
		var endpointParam = this.CONSTANTS.CATALOG_COLLECTION_QUERY + "('" + modelData['moKey'] + "')";
		var curriedSuccessFunc = com.tutorial.util.Utils.curry(successFunc);
	...
	createModel: function(noteContext) {
		com.tutorial.service.generic.ODataToJsonService.createLog("OBJECT_TYPES", "insert", noteContext['moData'], noteContext['moData']["KEY"]);
