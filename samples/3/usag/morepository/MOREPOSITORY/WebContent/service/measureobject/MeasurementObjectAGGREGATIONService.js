...
jQuery.sap.declare('com.tutorial.service.measureobject.MeasurementObjectAGGREGATIONService');

com.tutorial.service.measureobject.MeasurementObjectAGGREGATIONService = {
	...
	CONSTANTS : {
		CATALOG_COLLECTION_QUERY : 'AGGREGATION',
		ASYNC : false
	},
	...
	updateModel : function(modelData) {
		com.tutorial.service.generic.ODataToJsonService.createLog("AGGREGATIONS", "update", modelData['updatedData'], modelData['moKey']);
		var successFunc = modelData['successFunc'];
		var errorFunc = modelData['errorFunc'];
	...
	removeModel : function(modelData) {
		com.tutorial.service.generic.ODataToJsonService.createLog("AGGREGATIONS", "delete", modelData['moKey'], modelData['moKey']);
		var successFunc = modelData['successFunc'];
		var errorFunc = modelData['errorFunc'];
		var endpointParam = this.CONSTANTS.CATALOG_COLLECTION_QUERY + "('" + modelData['moKey'] + "')";
		var curriedSuccessFunc = com.tutorial.util.Utils.curry(successFunc);
	...
	createModel: function(noteContext) {
		com.tutorial.service.generic.ODataToJsonService.createLog("AGGREGATIONS", "insert", noteContext['moData'], noteContext['moData']["KEY"]);
