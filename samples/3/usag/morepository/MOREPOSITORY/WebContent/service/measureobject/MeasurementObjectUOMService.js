...
jQuery.sap.declare('com.tutorial.service.measureobject.MeasurementObjectUOMService');

com.tutorial.service.measureobject.MeasurementObjectUOMService = {
	...
	updateModel : function(modelData) {
		com.tutorial.service.generic.ODataToJsonService.createLog("UOM", "update", modelData['updatedData'], modelData['moKey']);
		var successFunc = modelData['successFunc'];
		var errorFunc = modelData['errorFunc'];
	...
	removeModel : function(modelData) {
		com.tutorial.service.generic.ODataToJsonService.createLog("UOM", "delete", modelData['moKey'], modelData['moKey']);
		var successFunc = modelData['successFunc'];
		var errorFunc = modelData['errorFunc'];
		var endpointParam = this.CONSTANTS.CATALOG_COLLECTION_QUERY + "('" + modelData['moKey'] + "')";
		var curriedSuccessFunc = com.tutorial.util.Utils.curry(successFunc);
	...
	createModel: function(noteContext) {
		com.tutorial.service.generic.ODataToJsonService.createLog("UOM", "insert", noteContext['moData'], noteContext['moData']["KEY"]);
