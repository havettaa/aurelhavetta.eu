...
jQuery.sap.declare('com.tutorial.service.measureobject.MeasurementObjectLegService');

com.tutorial.service.measureobject.MeasurementObjectLegService = {
	...
	CONSTANTS : {
		CATALOG_COLLECTION_QUERY : 'Products.json?$filter=KEY_PACKAGE eq \'{0}\'',
		ASYNC : true
	},
