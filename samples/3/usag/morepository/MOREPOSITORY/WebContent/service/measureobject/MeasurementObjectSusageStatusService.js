...
jQuery.sap.declare('com.tutorial.service.measureobject.MeasurementObjectSusageStatusService');

com.tutorial.service.measureobject.MeasurementObjectSusageStatusService = {
	...
	CONSTANTS : {
		CATALOG_COLLECTION_QUERY : 'SUSAGE_STATUS',
		ASYNC : false
	},
	...
	updateModel : function(modelData) {
		com.tutorial.service.generic.ODataToJsonService.createLog("SUSAGE_STATUS", "update", modelData['updatedData'], modelData['moKey']);
		var successFunc = modelData['successFunc'];
		var errorFunc = modelData['errorFunc'];
	...
	removeModel : function(modelData) {
		com.tutorial.service.generic.ODataToJsonService.createLog("SUSAGE_STATUS", "delete", modelData['moKey'], modelData['moKey']);
		var successFunc = modelData['successFunc'];
		var errorFunc = modelData['errorFunc'];
		var endpointParam = this.CONSTANTS.CATALOG_COLLECTION_QUERY + "('" + modelData['moKey'] + "')";
		var curriedSuccessFunc = com.tutorial.util.Utils.curry(successFunc);
	...
	createModel: function(noteContext) {
		com.tutorial.service.generic.ODataToJsonService.createLog("SUSAGE_STATUS", "insert", noteContext['moData'], noteContext['moData']["KEY"]);
